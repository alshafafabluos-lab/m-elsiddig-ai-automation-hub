              ...
              <div className="p-8">
                  ...
                  >
                    ...
                    <div className="relative flex items-center justify-center gap-3">
                      {isLoggingIn ? (
                        ...
                        <>
                          <ShieldCheck size={22} />
                          {lang === 'ar' ? 'فتح الحصن' : 'UNLOCK VAULT'}
                        </>
                      )}
                    </div>
                  </button>
                ...
                <div className="mt-8 pt-6 border-t border-white/5 text-center">
                   <p className="text-[10px] text-slate-600 uppercase tracking-widest font-bold mb-1">
                      {lang === 'ar' ? 'نظام الحماية النشط' : 'Active Protection System'}
                   </p>
                   <p className="text-[9px] text-slate-700 font-mono">ENCRYPTED-AES-256-SSL</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
